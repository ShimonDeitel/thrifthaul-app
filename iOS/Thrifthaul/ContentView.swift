...
struct ContentView: View {
    ...
    @State private var editingItem: Haul?
    ...
    private func amountText(_ item: Haul) -> String? {
...
struct EntryFormView: View {
    ...
    let mode: FormMode
    @State private var draft: Haul

    init(mode: FormMode) {
        self.mode = mode
        switch mode {
        case .add:
            _draft = State(initialValue: Haul())
        case .edit(let item):
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    TextField("RetailEstimate", value: $draft.retailEstimate, format: .number)
                        .keyboardType(.decimalPad)
                        .accessibilityIdentifier("field_retailEstimate")
